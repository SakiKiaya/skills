...
description: Analyze application configuration sources, code-level config path usage, environment variables, registry access, and hardcoded paths.
version: 0.7.0
...
Analyze application configuration sources, code-level config path usage, environment variables, registry access, and hardcoded paths.
