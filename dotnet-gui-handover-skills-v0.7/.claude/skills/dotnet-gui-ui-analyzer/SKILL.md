---
name: dotnet-gui-ui-analyzer
description: Analyze WinForms, WPF, Avalonia, MAUI UI screens, controls, commands, bindings, navigation, and UI responsibility.
version: 0.7.0
allowed-tools: Read Write Edit Bash
---

# dotnet-gui-ui-analyzer
...
Analyze WinForms, WPF, Avalonia, MAUI UI screens, controls, commands, bindings, navigation, and UI responsibility.
