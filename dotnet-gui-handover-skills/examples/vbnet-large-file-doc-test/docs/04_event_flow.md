...
## Event Flow Chunk Index

| Chunk ID | Title | Summary | Source Refs | Related |
|---|---|---|---|---|
| 0000_btnStart.Click_btnStart_Click | Event Flow: btnStart.Click -> btnStart_Click | Event-flow chunk for single user action or UI event. | Forms/MainForm.vb | method:Forms_MainForm.vb_btnStart_Click_19 |
| 0001_btnSave.Click_btnSave_Click | Event Flow: btnSave.Click -> btnSave_Click | Event-flow chunk for single user action or UI event. | Forms/MainForm.vb | method:Forms_MainForm.vb_btnSave_Click_24 |
