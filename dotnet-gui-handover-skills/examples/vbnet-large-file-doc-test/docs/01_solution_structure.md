...
```mermaid
graph TD
  P_VbLargeFileDocTest["VbLargeFileDocTest<br/>VB.NET"]
```
...
|---|---|---|---|---|
| VbLargeFileDocTest | Project: VbLargeFileDocTest | Project-level chunk for module responsibility and dependencies. | VbLargeFileDocTest.vbproj | N/A |
