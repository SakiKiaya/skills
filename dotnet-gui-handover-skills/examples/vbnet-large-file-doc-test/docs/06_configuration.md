...
### [Config File: App.config](chunks/configs/config_file_0000_App.config.md)
...
- 確認此設定來源是否為正式 runtime 設定。
- 檢查是否依賴特定機台路徑、環境變數或 Registry。


### [Config Reference: Forms/MainForm.vb:31](chunks/configs/config_ref_0000_Forms_MainForm.vb_31.md)

# Config Reference: Forms/MainForm.vb:31
