...
description: Generate OpenSpec-compatible specs for AI agents from enterprise GUI reverse engineering outputs.
version: 0.7.0
...
Generate OpenSpec-compatible specs for AI agents from enterprise GUI reverse engineering outputs.
