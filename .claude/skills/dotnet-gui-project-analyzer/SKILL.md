...
description: Top-level orchestrator for enterprise .NET GUI reverse engineering and handover documentation.
version: 0.7.0
...
Top-level orchestrator for enterprise .NET GUI reverse engineering and handover documentation.
